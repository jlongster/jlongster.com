...
export const union = (p1, p2) => operate(p1, p2, UNION);
export const intersect = (p1, p2) => operate(p1, p2, INTERSECT);
export const difference = (p1, p2) => operate(p1, p2, DIFFERENCE);
export const xor = (p1, p2) => operate(p1, p2, XOR);
